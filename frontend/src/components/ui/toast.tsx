...
// Toast without id for creation
interface ToastWithoutId extends Omit<Toast, "id"> {}
...
// 简化的toast函数
export function toast(props: ToastWithoutId) {
  if (!globalToastContext) {
    console.warn("Toast context not found. Toast not displayed.")
    return { id: "" }
  }
  const id = globalToastContext.addToast(props)
  return { id }
}
